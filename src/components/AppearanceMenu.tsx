...
export function AppearanceMenu() {
  ...
  return <div className="appearance-menu absolute right-0 top-[calc(100%+10px)] z-[70] w-72 p-3">
    <div className="flex items-center gap-2 px-2 py-1.5"><Palette className="w-3.5 h-3.5 text-[var(--accent)]" /><span className="text-[11px] font-semibold tracking-[0.12em] uppercase text-[var(--txt2)]">Appearance</span></div>
